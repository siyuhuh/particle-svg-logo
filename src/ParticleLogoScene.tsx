...
const surfaceFragmentShader = `
  ...
  void main() {
    ...
    vec3 rippleColor = mix(vec3(0.005, 0.01, 0.012), uColorAccent * 0.48, rippleSoft);
    ...
    vec3 lineColor = mix(vec3(0.012, 0.012, 0.013), uColorPrimary * 0.72, lineStripes * 0.78);
    ...
    vec3 silverDark = vec3(0.12, 0.118, 0.112);
    vec3 silverMid = vec3(0.57, 0.555, 0.525);
    vec3 silverBright = vec3(0.96, 0.95, 0.91);
    ...
    vec3 sideMetal = mix(vec3(0.08, 0.08, 0.075), vec3(0.62, 0.61, 0.56), sideSheen * 0.56 + sideDepth * 0.24);
    sideMetal *= 0.46 + sideDepth * 0.42;
    sideMetal += silverBright * smoothstep(0.72, 1.0, sideSheen) * 0.16;
    ...
    vec3 chromePrism = vec3(0.004, 0.004, 0.006);
    ...
    vec3 radianceCore = mix(vec3(0.28, 0.0, 0.022), vec3(1.0, 0.015, 0.0), redPlate);
    radianceCore += vec3(1.0, 0.18, 0.055) * hotCore * (0.26 + birthGlow * 0.42);
    vec3 radianceBeam = vec3(1.0, 0.0, 0.02) * pow(radianceGlow, 0.72);
    radianceBeam += vec3(0.42, 0.0, 0.08) * radianceGlow * 0.52;
    ...
    vec3 fluidCold = vec3(0.0, 0.012, 0.04) + uColorAccent * 0.05;
    ...
    mercuryColor -= vec3(0.11, 0.11, 0.105) * mercuryDarkFold * (0.32 + uScatter * 0.06);
    ...
    vec3 fluidGlassTint = mix(
      uColorAccent * 0.1 + vec3(0.006, 0.014, 0.018),
      uColorPrimary,
    ...
    fluidGlassColor -= vec3(0.0, 0.016, 0.022) * fluidGlassShadow;
